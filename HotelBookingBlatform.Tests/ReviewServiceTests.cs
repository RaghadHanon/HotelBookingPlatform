...
public class ReviewServiceTests
{
    ...
    {
        // Arrange
        var requestParameters = new GetHotelReviewsQueryParameters { PageNumber = pageNumber, PageSize = pageSize };
        var expectedReviews = _fixture.Build<Review>()
             .Without(r => r.Guest)
             .Without(r => r.GuestId)
             .Without(r => r.Hotel)
             .Without(r => r.HotelId)
        ...
        var expectedPaginatedResult = new PaginatedResult<Review>(expectedReviews.Skip(skippedReviews).Take(pageSize).ToList(), expectedPaginationMetadata);
        ...
        // Act
        var paginatedResult = await sut.GetHotelReviewsAsync(hotel.Id, requestParameters);
    ...
    public async Task AddReviewAsync_ShouldCreateReview_WhenHotelExistsAndGuestIsAuthorized()
    {
        ...
        var guest = _fixture.Build<Guest>()
             ...
             .Create();
        var currentUserId = "ghsdk-lkjhs-557sl";
        var createOrUpdateReviewDto = _fixture.Create<CreateOrUpdateReviewDto>();
        ...
        // Act
        var result = await sut.AddReviewAsync(hotel.Id, createOrUpdateReviewDto);
    ...
    public async Task UpdateReviewAsync_ShouldUpdateReview_WhenGuestIsAuthorized()
    {
        ...
        // Act
        var result = await sut.UpdateReviewAsync(hotel.Id, review.Id, createOrUpdateReviewDto);
    ...
    public async Task GetReviewAsync_ShouldReturnReview_WhenReviewExists()
    {
        ...
        // Act
        var result = await sut.GetReviewAsync(hotel.Id, review.Id);
    ...
    public async Task GetHotelAverageRatingAsync_ShouldReturnRoundedAverageRating_WhenHotelExists()
    {
        ...
        // Act
        var result = await sut.GetHotelAverageRatingAsync(hotel.Id);
